  ...
  return ReactDOM.createPortal(
    ...
    >
      <div
        ...
        className='max-w-3xl relative mx-8 min-h-96 w-full outline-4 outline-neutral-600 rounded-lg bg-neutral-800 shadow-[0px_0px_27px_0px_#2D2D2D] overflow-hidden'
